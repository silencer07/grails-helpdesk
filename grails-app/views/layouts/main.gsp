        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-warning fa-fw"></i> Incident Reports <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">File Incident Ticket</a>
                            </li>
                            <li>
                                <a href="#">View All Incident Tickets</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-laptop fa-fw"></i> Equipment Borrowing <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#"> Request Equipments</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-calendar fa-fw"></i> Event Support <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#"> Request Event Support</a>
                            </li>
                            <li>
                                <a href="#">View All Equipments</a>
                            </li>
